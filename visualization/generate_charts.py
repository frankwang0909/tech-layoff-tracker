...
const i18n = {
    en: {
        ...
        footer: 'Data Sources: <a href="https://layoffs.fyi/" target="_blank">layoffs.fyi</a> · RationalFX · Major tech media<br>Disclaimer: Some figures are estimates or planned reductions<br><br>Built with Python · BeautifulSoup · Pandas · ECharts &nbsp;|&nbsp;<a href="https://github.com" target="_blank">⭐ View on GitHub</a>',
        yAxisName: 'Layoffs',
        seriesBar: 'Layoffs',
        seriesLine: 'Trend',
        reasons: [
    ...
    zh: {
        ...
        footer: '数据来源: <a href="https://layoffs.fyi/" target="_blank">layoffs.fyi</a> · RationalFX · 各大科技媒体公开报道<br>免责声明: 部分数据为估计值或分阶段实施的计划裁员人数<br><br>Built with Python · BeautifulSoup · Pandas · ECharts &nbsp;|&nbsp;<a href="https://github.com" target="_blank">⭐ View on GitHub</a>',
        yAxisName: '裁员人数',
        seriesBar: '裁员人数',
        seriesLine: '趋势线',
        reasons: [
